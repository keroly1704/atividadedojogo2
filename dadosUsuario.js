document.addEventListener("DOMContentLoaded", function() {
    ...
    for (let i = 0; i < 50; i++) {
        ...
        piece.style.backgroundImage = `url('https://tismoo.us/wp-content/uploads/2023/03/Depositphotos_118995148_S.jpg')`;
    ...
    function handleClick() {
        ...
        const emptyPiece = pieces.find(piece => parseInt(piece.style.order) == 49);
